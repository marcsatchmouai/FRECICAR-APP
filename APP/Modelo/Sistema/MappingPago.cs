...
namespace Mapping.Sistema
{
    public class MappingPago
    {
        ...
        private List<Entidades.Sistema.Pago> _ColeccionPagos;
        ...
        private MappingPago()
        {
            _ColeccionPagos = new List<Entidades.Sistema.Pago>();
             RecuperarPagos();
        }
        ...
        public List<Entidades.Sistema.Pago> Recuperar()
        {
            return _ColeccionPagos;
        }
