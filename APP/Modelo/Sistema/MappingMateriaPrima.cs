...
namespace Mapping.Sistema
{
    ...
    {
        private List<Entidades.Sistema.MateriaPrima> _Lista;
        ...
        {
            _Lista = new List<Entidades.Sistema.MateriaPrima>();
            RecuperarMateriasPrimas();
        }
        ...
        public List<Entidades.Sistema.MateriaPrima> ListarMateriasPrimas()
        {
            return _Lista;
        }
        private void RecuperarMateriasPrimas()
        {
            Utilidades.Conexion Conexion = new Utilidades.Conexion();
            Conexion.Conectar("Sistema");
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    Categoria = MappingCategoria.ObtenerInstancia().DevolverLista().Find(x => x.Nombre == dr["Nombre"].ToString());
                    ...
                    Proveedor = MappingProveedor.ObtenerInstancia().ListarProveedores().Find(x => x.Cuit ==proveedor );
                    MateriaPrima.Proveedor = Proveedor;
                    _Lista.Add(MateriaPrima);
                    MateriaPrima = null;
                }
            }
            catch (SqlException Ex)
