...
namespace Mapping.Sistema
{
    public class MappingRemitoProveedor
    {
        ...
        public List<Entidades.Sistema.RemitoProveedor> ListarRemitoProveedor()
        {
            List<Entidades.Sistema.RemitoProveedor> _RemitoProveedor = new List<Entidades.Sistema.RemitoProveedor>();
            Servicios.Conexion Conexion = new Servicios.Conexion();
            Conexion.Conectar("Sistema");
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    Entidades.Sistema.Proveedor Proveedor = MappingProveedor.ObtenerInstancia().RecuperarProveedor().Find(x => x.Cuit == Convert.ToInt64(dr["Cuit"]));
                    ...
                    while (dr2.Read())
                    {
                        ...
                        DetalledeRemitoProveedor.MateriaPrima = MappingMateriaPrima.ObtenerInstancia().RecuperarMateriasPrimas().Find(x => x.Codigo ==Convert.ToInt32(dr2["CodigoMateriaPrima"]));
