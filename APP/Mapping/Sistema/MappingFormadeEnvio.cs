...
namespace Mapping.Sistema
{
    public class MappingFormadeEnvio
    {
        ...
        public List<Entidades.Sistema.FormadeEnvio> RecuperarFormadeEnvio()
        {
            List<Entidades.Sistema.FormadeEnvio> _FormadeEnvio = new List<Entidades.Sistema.FormadeEnvio>();
            Servicios.Conexion Conexion = new Servicios.Conexion();
            Conexion.Conectar("Sistema");
            try
            {
