...
namespace Mapping.Sistema
{
    public class MappingCliente
    {
        ...
        public List<Entidades.Sistema.Cliente> ListarClientes(bool situacion = false)
        {
            List<Entidades.Sistema.Cliente> _Clientes = new List<Entidades.Sistema.Cliente>();
            Servicios.Conexion Conexion = new Servicios.Conexion();
            Conexion.Conectar("Sistema");
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    Entidades.Sistema.Provincia prov = MappingProvincia.ObtenerInstancia().RecuperarProvincias().Find(x=>x.Nombre == provincia);
        ...
        public List<Entidades.Sistema.Cliente> ListarClientesActivos()
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    Entidades.Sistema.SituacionFiscal oSituacionFiscal = MappingSituacionFiscal.ObtenerInstancia().RecuperarSituacionFiscal().Find(x => x.Codigo == Convert.ToInt32(dr["SituacionFiscal"]));
